...
fun ProgressScreen(
    ...
    Scaffold(
        ...
        Column(
            modifier = Modifier
                .fillMaxSize()
                .padding(innerPadding) // отступы, чтобы избежать наложения
                .background(color = palette.background),
        ) {
            Box(
                modifier = Modifier
                    .fillMaxWidth()
                    .weight(0.2f) // оставшееся пространство
            ) {
                Column(
                    verticalArrangement = Arrangement.spacedBy(5.dp), // расстояние между элементами
                    modifier = Modifier
                ...
                Image(
                    painter = painterResource(id = R.drawable.image_character_lvl1_1),
